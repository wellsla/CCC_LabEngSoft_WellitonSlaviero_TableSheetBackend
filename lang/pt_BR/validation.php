...
return [
    ...
    */
    ...
    'custom' => [
        'username' => [
            'unique' => 'Este nome de usuário já está em uso. Por favor, escolha outro nome de usuário.',
        ],
        'email' => [
            'unique' => 'Este endereço de email já está cadastrado. Por favor, use outro email ou faça login com sua conta existente.',
        ],
        'name' => [
            'unique' => 'Este nome já está em uso. Por favor, escolha outro nome.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'wisdom' => 'sabedoria',
        'charisma' => 'carisma',
        'current_hit_points' => 'pontos de vida atuais',
        'max_hit_points' => 'pontos de vida máximos',
        'armor_class' => 'classe de armadura',
        'initiative' => 'iniciativa',
        'speed' => 'velocidade',
        'notes' => 'anotações',
        'portrait_url' => 'URL do retrato',
    ],
